...
<!--    plugins-->
    ...
    <link rel="stylesheet" href="<?php echo bower_url('Waves/dist/waves.css')?>" />
<!--    end plugins-->
            ...
            <div class="box bg-white">
                <div class="navbar md-whiteframe-z1 no-radius blue">
                  ...
                  <path d="M 50 0 L 100 14 L 92 80 Z" fill="rgba(139, 195, 74, 0.5)"></path>
                        ...
                        <img src="<?php echo images_url('logo.png')?>" alt="." style="max-height: 36px; display:none">
                        ...
                        <div class="box-inner">
                            <div class="p hidden-folded blue-50" style="background-image:url(images/bg.png); background-size:cover">
                                <div class="rounded w-64 bg-white inline pos-rlt">
                                    <img src="<?php echo images_url('a0.jpg')?>" class="img-responsive rounded">
                                </div>
    ...
    <div id="content" class="app-content" role="main">
        <div class="box">
            ...
            <div class="navbar md-whiteframe-z1 no-radius blue">
                ...
                <div class="navbar-item pull-left h4">Blank</div>
                <!-- / -->
                <!-- Common tools -->
...
<script type="text/javascript" src="<?php echo bower_url('Waves/dist/waves.js')?>"></script>

<script src="<?php echo js_url('ui-load.js')?>"></script>
<script src="<?php echo js_url('ui-jp.config.js')?>"></script>
<script src="<?php echo js_url('ui-jp.js')?>"></script>
<script src="<?php echo js_url('ui-nav.js')?>"></script>
<script src="<?php echo js_url('ui-toggle.js')?>"></script>
<script src="<?php echo js_url('ui-form.js')?>"></script>
<script src="<?php echo js_url('ui-waves.js')?>"></script>
<script src="<?php echo js_url('ui-client.js')?>"></script>
